__author__ = 'vfdev' # Modified by Simewu to include timestamps
...
def main(args):
    ...
    timestampFile = open(os.path.join(args.output, 'timestamp_map.csv'), 'w')
    timestampFile.write('Frame number,Milliseconds,\n')
